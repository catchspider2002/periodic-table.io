...
function setColor(themeColor) {
  ...
  newStyle.appendChild(document.createTextNode(".navbar-default,.navbar-collapse.in{background: linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.35)), linear-gradient(to right, rgb(" + themeColor + "), rgb(" + themeColor + "))}"));
  newStyle.appendChild(document.createTextNode("button.sort,.navbar-toggle{background: linear-gradient(to right, rgba(0, 0, 0, 0.35), rgba(0, 0, 0, 0.35)), linear-gradient(to right, rgb(" + themeColor + "), rgb(" + themeColor + "))}"));

  if (derivedLang === "ar" || derivedLang === "fa" || derivedLang === "he")
    newStyle.appendChild(document.createTextNode(".listNum{border-color:rgba(" + themeColor + ",0.5) transparent transparent transparent}"));
  else
    newStyle.appendChild(document.createTextNode(".listNum{border-color:transparent rgba(" + themeColor + ",0.5) transparent transparent}"));
