...
function setColor(themeColor) {
  ...
  newStyle.appendChild(document.createTextNode(".navbar-default,button.sort,.navbar-toggle,.navbar-collapse.in{background: linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), linear-gradient(to right, rgb(" + themeColor + "), rgb(" + themeColor + "))}"));
