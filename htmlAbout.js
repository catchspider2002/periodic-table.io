...
const writeFile = (lang, langValues, page, defaultHead, metaTags, defaultNav, nav4, defaultFooter) => {
  ...
  writeStream.write(`${checkIcon}<div>Updated Czech, Esperanto, Greek, French, Vietnamese, Chinese Traditional, Indonesian, Romanian and Swedish translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Italian, Dutch, German, Portuguese, Polish, Croatian, Russian, Armenian, Japanese and Chinese (Simplified) translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Norwegian Bokmal, Spanish, Vietnamese, Chinese(Simplified), Chinese(Traditional), Japanese, German, Portuguese, French and Italian translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Armenian, Greek, Spanish, Italian, Portuguese, Slovenian, Thai, Vietnamese and Chinese(Simplified) translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Added a new printable - Flash Cards in <a class='underlineLink' href='printables'>Printables</a> page</div>`);
  writeStream.write(`${checkIcon}<div>Updated Croatian, Greek, Hebrew, Hindi, Norwegian Bokmal, Polish, Romanian, Vietnamese and Dutch translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Arabic, Persian, Hindi, Italian, Indonesian, Vietnamese, German, Greek, Polish, Dutch, Slovak, Chinese (Simplified) and Chinese (Traditional) translations</div>`);
  
  writeStream.write("<div class='versionHeader'>Jul 2020</div>");
  writeStream.write(`${checkIcon}<div>Added a new printable in <a class='underlineLink' href='printables'>Printables</a> page</div>`);
  writeStream.write(`${checkIcon}<div>Added a new page - <a class='underlineLink' href='translation'>Translation</a> where you can check the status of each language and contribute translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated the navbar header from a gradient to solid color which now matches with the window color when opened as PWA</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Added a new printable in <a class='underlineLink' href='printables'>Printables</a> page</div>`);
  writeStream.write(`${checkIcon}<div>Added <a class='underlineLink' target='_blank' href='https://feedback.periodic-table.io/' rel='noopener noreferrer'>Suggestions</a> where new suggestions or feature requests can be provided</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Added a new page - <a class='underlineLink' href='printables'>Printables</a> which provides a printable version of the periodic table which will be updated regularly</div>`);
  writeStream.write(`${checkIcon}<div>Added a new page - <a class='underlineLink' href='credits'>Credits</a> for translations which was earlier appearing in About page</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Removed theme switching to enable light or dark mode from Settings and a dedicated button is available in the top navigation bar</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Persian, Croatian, Hungarian, Polish, Greek, Hebrew, Portuguese, German, Spanish, Chinese (Traditional), Russian, Thai, French, Italian, Chinese (Simplified) and Turkish translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Chinese (Simplified), Portuguese, Spanish, Indonesian, Vietnamese and Chinese (Traditional) translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Arabic, Chinese (Traditional), Chinese (Simplified), Portuguese, Catalan, German and Japanese translations</div>`);
  ...
  writeStream.write(`${checkIcon}<div>Updated Persian, Czech, Italian, Dutch, Catalan, Vietnamese, Hungarian, Indonesian and Japanese translations</div>`);
