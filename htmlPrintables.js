...
const writeFile = (lang, langValues, page, defaultHead, metaTags, defaultNav, defaultFooter) => {
  ...
  printableLinks.forEach((printableLink) => {
    writeStream.write("<div class='flex flex-col font-size-15 overflow-auto'>");
...
//           rating=0
//           supported={Lang.languages}
//           languages=' {Lang.enTrans}; {Lang.arTrans}; {Lang.bgTrans}; {Lang.caTrans}; {Lang.csTrans}; {Lang.daTrans}; {Lang.deTrans}; {Lang.elTrans}; {Lang.esTrans}; {Lang.faTrans}; {Lang.fiTrans}; {Lang.frTrans};
//               {Lang.hiTrans}; {Lang.hrTrans}; {Lang.huTrans}; {Lang.idTrans}; {Lang.itTrans}; {Lang.jaTrans}; {Lang.koTrans}; {Lang.msTrans}; {Lang.nlTrans}; {Lang.nnTrans}; {Lang.plTrans};
//               {Lang.heTrans}; {Lang.ptTrans}; {Lang.roTrans}; {Lang.ruTrans}; {Lang.skTrans}; {Lang.slTrans}; {Lang.srTrans}; {Lang.svTrans}; {Lang.thTrans}; {Lang.trTrans}; {Lang.ukTrans};
//               {Lang.viTrans}; {Lang.zhTrans}; {Lang.chTrans};'
//           image='Periodic Table Flashcards 1'
//           link='https://gumroad.com/l/periodictableflashcards1/'
//           downloadLang={Lang.download} />
